            ...
            for (int i = 0; i < path.NumPoints; i++)
            {
                ...
                switch (moveTool)
                {
                    ...
                    case MoveTools.Move2D:
                        var fmh_72_96_639148832297258265 = Quaternion.identity; newPos = Handles.FreeMoveHandle(path.GetPoint(i, road.positionOffset), handleSize, Vector2.zero, Handles.SphereHandleCap);
